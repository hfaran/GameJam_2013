...
Bool Init()
{
   ...
   Gui+=viewport[0].create(Rect_C(-0.5f, 0, 0.9f, 0.9f),ViewportDraw,(Ptr)0); // create a viewport with 'user=0' to mark camera[0] usage
   Gui+=viewport[1].create(Rect_C( 0.5f, 0, 0.9f, 0.9f),ViewportDraw,(Ptr)1); // create a viewport with 'user=1' to mark camera[1] usage
